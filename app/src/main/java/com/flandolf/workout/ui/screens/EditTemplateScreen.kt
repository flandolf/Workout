...
fun AddTemplateScreen(
    ...
    Scaffold(topBar = {
        ...
        Column(
            ...
            AnimatedVisibility(visible = addExerciseVisible) {
                Column(Modifier.fillMaxWidth()) {
                    ...
                    LaunchedEffect(Unit) {
                        ...
                        editVm.loadExerciseNameSuggestions { fromDb ->
            ...
            val sortedExercises = remember(template) {
                template.sortedWith(compareBy({ it.exercise.position }, { it.exercise.id }))
            }
